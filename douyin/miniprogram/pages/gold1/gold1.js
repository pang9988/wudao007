...
Page({
  ...
  onLoad: function (options) {
    // var that=this;
    this.data.cao = [{ img: "./../../images/hometu/11.jpg", site: "廉江", imgtx: "./../../images/hometu/13.jpg", textwz: "你不离我不弃" },
    { img: "./../../images/hometu/1.jpg", site: "廉江1", imgtx: "./../../images/hometu/2.jpg", textwz: "界面信息元素没有做到对" },
    { img: "./../../images/hometu/11.jpg", site: "廉江2", imgtx: "./../../images/hometu/7.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出。背面的说明文字缺乏层次感。图三的整体层次感没有很好的凸现出来" },
    { img: "./../../images/hometu/3.jpg", site: "廉江3", imgtx: "./../../images/hometu/4.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出" },
    { img: "./../../images/hometu/4.jpg", site: "廉江4", imgtx: "./../../images/hometu/1.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出" },
    { img: "./../../images/hometu/1.jpg", site: "廉江11", imgtx: "./../../images/hometu/3.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出" },
    { img: "./../../images/hometu/2.jpg", site: "廉江12", imgtx: "./../../images/hometu/4.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出。背面的说明文字缺乏层次感。图三的整体层次感没有很好的凸现出来" },
    { img: "./../../images/hometu/3.jpg", site: "廉江3", imgtx: "./../../images/hometu/4.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出" },
    { img: "./../../images/hometu/4.jpg", site: "廉江4", imgtx: "./../../images/hometu/1.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出" },
    { img: "./../../images/hometu/1.jpg", site: "廉江11", imgtx: "./../../images/hometu/3.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出" },
    { img: "./../../images/hometu/2.jpg", site: "廉江12", imgtx: "./../../images/hometu/4.jpg", textwz: "界面信息元素没有做到对齐，365元作为重要信息没有很好突出。背面的说明文字缺乏层次感。图三的整体层次感没有很好的凸现出来" }];
